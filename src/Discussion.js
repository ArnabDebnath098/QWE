  ...
  return (
    <div className="discussion">
      <div className="discussionHeader">
        ...
        <div className="discussionHeader-right" onClick={handleOpen}>
          <p>Add post</p>
      ...
      <div className="discussionCards">
        <DiscussionCard
          questionimage="https://miro.medium.com/max/3600/1*Xt3l-_54wuxdsHpiolGP3g.jpeg"
          topicName="React Js"
          author="Reactjs.org"
      ...
      >
        <Fade in={open}>
          <div className="paperArticle">
            ...
            <input className="inputfile" type="file" id="files" name="files" />
